       ...
       <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12">
             <div class="col p-0">
               <div class="card shadow mb-4 rounded-0">
                 <!-- Card Header - Dropdown -->
                 <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-muted">Today Attendance Report</h6>
                 </div>
                 <!-- Card Body -->
                 <div class="card-body" style="max-height: 370px;">
                   <table class="table table-bordered table-striped">
                     <thead class="bg-gradient-primary text-white">
                       <tr>
                         ...
                         <th class="p-1" scope="col">Time in</th>
                         <th class="p-1" scope="col">Time out</th>
                       </tr>
                     </thead>
                     <tbody>
                       <?php $i = 1;
                        ...
                        <tr>
                        <th class="text-center p-1" scope="row"><?= $i++ ?></th>
                        <td class="p-1"><?= $a['name'] ?> </td>
                        <td class="p-1"><?= date('h:i:s A', $a['in_time'])  ?> </td>
                        <td class="p-1"><?= $a['out_time'] > 0 ? date('h:i:s A', $a['out_time']) : 'Haven\'t Checked Out'; ?></td>
                        </tr>
